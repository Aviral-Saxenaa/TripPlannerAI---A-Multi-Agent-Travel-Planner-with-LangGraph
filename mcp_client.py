...
# only tools u need in tavilysearch you provide that tool 
# it will search and invoke ai for same tool objects
...
# only tools u need in aviation mcp you provide that tool 
# it will search and invoke ai for same tool objects
