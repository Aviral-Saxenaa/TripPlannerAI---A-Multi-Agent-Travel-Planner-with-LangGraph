...
# checks whether one particular airport belongs to a given country
...
# get_best_airport_for_country() collects the matching airports and scores them to select one best airport, rather than returning all of them 
...
# Convert user location to airport IATA code
